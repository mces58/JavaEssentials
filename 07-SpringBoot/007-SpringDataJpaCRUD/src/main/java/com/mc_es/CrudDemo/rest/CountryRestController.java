...
public class CountryRestController {
	...
	@GetMapping(value = "/countries/continent/{continent}")
	public List<Country> findByPopulation(@PathVariable String continent) {
		return countryService.findByContinent(continent);
	}

	@GetMapping(value = "/countries/orderBy")
	public List<Country> findByOrderByCountryCodeAsc() {
		return countryService.findByOrderByCountryCodeDesc();
	}
}
